...
const Header = () => {
        ...
        const navLinks = [
                ...
                { name: 'Blog', path: '/blog' },
                { name: 'Live', path: '/live' },   // in the navLinks array
                                        ...
                                        <nav className="hidden md:flex md:items-center md:space-x-1">
                                                {navLinks.map((link) => (
                                                        <Link
                                                                key={link.path}
                                                                to={link.path}
                                                                className={`relative px-4 py-2 text-sm font-medium transition-all duration-200 ${isActive(link.path)
                                                                        ? 'text-primary'
                                                                ...
                                                                <nav className="flex flex-col space-y-3">
                                                                        {navLinks.map((link) => (
                                                                                <Link
                                                                                        ...
                                                                                        to={link.path}
                                                                                        onClick={() => setIsOpen(false)}
                                                                                        className={`px-4 py-3 text-base font-medium transition-all duration-200 rounded-lg ${isActive(link.path)
